...
* mobile device.
* Progam your own shader function in `howWeDoingMan` in DestroyMySweater.metal.
...
do {
  let path = Bundle.main.path(forResource: "DestroyMySweater", ofType: "metal")
...
renderer.functionName = "howWeDoingMan"
